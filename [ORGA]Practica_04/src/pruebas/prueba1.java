...
public class prueba1 extends javax.swing.JFrame {
    ...
    JLabel[] g = new JLabel[10];
    JLabel matriz1 = new JLabel();
    public prueba1() {
        initComponents();
        matriz1.setSize(35, 35);
        matriz1.setOpaque(true);
        matriz1.setBackground(Color.green);
        Snake1.add(matriz1);
        animacion(1);
    ...
    private void animacion(int k) {
        int posx=10,posy=100;
        System.out.println("Tamaño es:" + Snake1.size());
        for (int i = 0; i < k; i++) {
            g[i] = new JLabel();
            g[i].setBounds(posx, posy, 35, 35);
            g[i].setOpaque(true);
